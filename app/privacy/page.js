      ...
      <div className="doc">
        <div className="doc-wrap">
          ...
          <p className="doc-p">
            ...
            emails, <strong>Cloudinary</strong> for video recording storage,{' '}
            <strong>AssemblyAI</strong> for speech-to-text transcription and
            audio analysis, and <strong>Modal</strong> for generating the
            interviewer&rsquo;s spoken voice from interview question text.
          </p>
          <p className="doc-p">
            The speech generation runs on an open-source model hosted on our own
            infrastructure. Question text is sent only there and is never shared
            with a third-party voice provider. Candidate video, audio answers,
            transcripts and scores are never sent to the speech service at all.
          </p>
          ...
          <p className="doc-p">
            The interviewer&rsquo;s voice is generated by AI. There is no human
            interviewer present during the interview, and no live person hears
            the responses as they are given.
          </p>
