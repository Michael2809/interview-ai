 ...
 *
 * Deliberately does NOT block CANCELLED on its own. Somebody who cancels
 * has paid through the end of their period and keeps what they bought
 * until then — cutting them off the moment they click cancel would be
 * taking money for time they cannot use. effectiveStatus() turns a
 * cancellation into EXPIRED once that date passes, which is what closes
 * the "cancel means free forever" hole; this function does not need to
 * do it twice, and doing it early would be wrong.
 */
